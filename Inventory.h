...
#include <iostream>
This class is missing a number of functions.

Rewrite the class declaration to follow best practices, e.g., operators, three important functions, and printing. The functions you write must be const-correct. You do not need to create, an iterator, begin function, or end function.
...
bool Inventory::addItems(ItemStack itemStack)
{
    ...
    if(matchingNode != nullptr){
        ItemStack& matchingStack = (matchingNode->data);        
        matchingStack.addItems(itemStack.size());
